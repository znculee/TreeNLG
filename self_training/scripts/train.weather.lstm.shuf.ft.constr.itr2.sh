...
model=lstm
pct=pct-$1
SAVEDIR=self_training/checkpoints/$data/$pct/shuf.ft.constr.itr2.$model
RESTORECKP=self_training/checkpoints/$data/$pct/shuf.plbl.constr.itr2.$model/checkpoint_best.pt
