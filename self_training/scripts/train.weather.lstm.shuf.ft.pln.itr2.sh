...
model=lstm
pct=pct-$1
SAVEDIR=self_training/checkpoints/$data/$pct/shuf.ft.pln.itr2.$model
RESTORECKP=self_training/checkpoints/$data/$pct/shuf.plbl.pln.itr2.$model/checkpoint_best.pt
