...
model=lstm
pct=pct-$1
SAVEDIR=self_training/checkpoints/$data/$pct/shuf.ft.rrk-rev.rev.$model
RESTORECKP=self_training/checkpoints/$data/$pct/shuf.plbl.rrk-rev.rev.$model/checkpoint_best.pt
