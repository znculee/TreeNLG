...
model=lstm
pct=pct-$1
SAVEDIR=self_training/checkpoints/$data/$pct/shuf.ft.rrk-gpt2.$model
RESTORECKP=self_training/checkpoints/$data/$pct/shuf.plbl.rrk-gpt2.$model/checkpoint_best.pt
