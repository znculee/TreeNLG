...
"""
Translate pre-processed data with a trained model and
rerank generations in the beam with a score function.
"""
...
def _main(args, output_file):
    ...
    has_target = True
    wps_meter = TimeMeter()
    reranker = Reranker(args, src_dict, tgt_dict)
    for sample in progress:
        ...
        hypos = reranker.rerank_hypos(sample, hypos)
